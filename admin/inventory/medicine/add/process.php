    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_POST["action"])) {
            ...
            if ($_POST['action'] === 'add_medicine') {
                ...
                // $checkmedicine="SELECT id FROM medicine WHERE ((first_name='$first_name' AND last_name='$last_name') OR contact_number='$contact_number')";
                ...
                // $sqlInsertmedicine = "INSERT INTO medicine(first_name , last_name , contact_number , address, user_id, date_of_birth, job_title, employment_date) VALUES ('$first_name','$last_name','$contact_number', '$address', '$user_id', '$date_of_birth', '$job_title', '$employment_date')";
